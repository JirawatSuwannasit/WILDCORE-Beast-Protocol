...
- [x] **Leg-direction list:** `R, R, D, R, U, U, R, R, U, R, D, R, R, U, U, R, R, R, D, U, U, U, R, U, U, R, D, R, D, D, R, U, R, D, R`.
- [x] **Dominant direction changes:** **23**, passing the ≥4 requirement.
- [x] **Longest same-direction run:** **3 screens**, passing the no-run-of->3 requirement.
...
- [x] **Rising lava placement:** `risingLava-chase` is inside the setpiece section box: setpiece `x=5568 y=2368 w=320 h=1600`; rising lava `x=5568 y=2688 w=320 h=960`.
...
## Fairness
- [x] **Base-kit traversal:** maximum audited void gap is **3 tiles / 48 px**, within the no-dash base kit. Full-column empty-run audit: cols 85-88, 97-100, 149-152, 343-346, and 493-496 are all 3 tiles.
